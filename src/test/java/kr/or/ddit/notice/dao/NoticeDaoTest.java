...
public class NoticeDaoTest {
	...
	public void noticeTotalCntTest() {
		...
		/***Then***/
		assertEquals(26, noticeTotalCnt);
	}
	...
	public void getAllNoticePageTest() {
		...
		map.put("pageSize", 10);
		/***When***/
		List<NoticeVo> nvoList = noticeDao.getAllNoticePage(sqlSession, map);
		/***Then***/
	...
	public void getFileTest() {
		...
		/***Then***/
		assertEquals(38, nfvo.getFilenum());
	}
